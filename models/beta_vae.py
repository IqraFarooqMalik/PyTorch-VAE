...
class BetaVAE(BaseVAE):
    ...
    def __init__(self,
                 in_channels: int,  # Should be 3 for RGB images
                 latent_dim: int,
        ...
        for h_dim in hidden_dims:
            ...
            in_channels = h_dim  # Update in_channels after each layer

        self.encoder = nn.Sequential(*modules)

        # Pass a dummy input to calculate the flattened size
        dummy_input = torch.zeros(1, 3, 256, 256)  # Ensure input is RGB (3 channels)
